...
SECRET_KEY = 'django-insecure-_4h9w2me&a4rm_f46e)trm(7&#btfp6*4^er78$(ln9xnntbcm'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv("DB_NAME"),         # The name of the database you created
        'USER': os.getenv("DB_USER"),         # Your MySQL username
        'PASSWORD': os.getenv("DB_PASSWORD"), # Your MySQL password
        'HOST': '127.0.0.1',             # Or 'localhost', or your db host
